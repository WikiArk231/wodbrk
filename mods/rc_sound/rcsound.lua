...
SOUNDS = {
	...
	-- Boss
		{fromPos = {x=93, y=163, z=7}, toPos = {x=107, y=172, z=7}, priority = 0, sound="Fairy Tail - Main.ogg"},
	
	-- Main --
		{fromPos = {x=2, y=24, z=0}, toPos = {x=4000, y=4000, z=15}, priority = 1, sound="background.ogg"},		
